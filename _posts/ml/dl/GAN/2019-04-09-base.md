...
<center class="half">
  <iframe width="500" height="380" src="/assets/images/ml/dl/GAN/barrel-effect.gif">木桶效应</iframe>&emsp;
</center>   
...
<center class="half">
  <iframe width="400" height="390" src="/assets/images/ml/dl/GAN/conv.gif" ></iframe><br>图1：卷积<br>&emsp;
</center>    
- **反卷积**
转置卷积、微步卷积；目的是上采样；   
<center class="half">
  <iframe width="360" height="400" src="/assets/images/ml/dl/GAN/dconv.gif" ></iframe><br>图2：转置卷积<br>&emsp;<iframe width="390" height="460" src="/assets/images/ml/dl/GAN/fconv.gif" ></iframe><br>图3：微步卷积<br>&emsp;
</center>    
...
\log P(y\|x) &= y \log P(x) + (1-y) \log (1 - P(x))  \label{log_label}\\
\end{align}
$$
