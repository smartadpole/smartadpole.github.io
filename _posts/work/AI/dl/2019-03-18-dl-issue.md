...
<span id="calc_feature_map">**2. 计算 feature map 大小**</span>    
{:.warning}  
输出的 feature map 大小：
...
<span id="input_channel">**3. 深度学习算法的输入,必须是 RGB 三通道吗**</span>    
{:.warning}  
...
<span id="input_channel">**4. 图像领域卷积神经网络大行其道 传统的图像处理还有意义吗**</span>    
{:.warning}  
